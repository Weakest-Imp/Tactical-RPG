...
public class BoardCreator : MonoBehaviour {
	...
	//Operations on tiles_________________________________________________________________

	Rect RandomRect ()
	//Return a random area (not a point)
	{
	...
	//User Interface________________________________________________________________
